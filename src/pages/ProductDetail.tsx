      ...
      <div className="glass-panel grid grid-cols-1 gap-8 overflow-hidden rounded-3xl border border-white/10 p-6 shadow-[0_0_50px_rgba(79,70,229,0.15)] sm:p-8 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-between space-y-6">
          <div className="space-y-4">
            <span className="inline-flex items-center gap-1.5 rounded border border-indigo-500/20 bg-indigo-500/10 px-2.5 py-1 font-mono text-[9px] font-bold uppercase tracking-widest text-indigo-300">
